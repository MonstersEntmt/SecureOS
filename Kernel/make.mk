...
KERNEL_LIBC_C_OBJS := $(KERNEL_LIBC_C_SRCS:%=Bin-Int/%.o)
KERNEL_LIBC_ASM_OBJS := $(KERNEL_LIBC_ASM_SRCS:%=Bin-Int/%.o)
KERNEL_C_OBJS := $(KERNEL_C_SRCS:%=Bin-Int/%.o)
KERNEL_ASM_OBJS := $(KERNEL_ASM_SRCS:%=Bin-Int/%.o)
...
Bin/UEFI/secure-os/kernel.elf: $(KERNEL_OBJS)
	mkdir -p $(dir $@)
	$(LD) $(KERNEL_LDFLAGS) -o $@ $(KERNEL_OBJS)
	echo Linked Kernel

Kernel: Bin/UEFI/secure-os/kernel.elf